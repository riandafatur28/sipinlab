            ...
            <div class="bg-yellow-50 border border-yellow-300 rounded-lg p-6">
                ...
                <div class="space-y-3 text-sm text-gray-700">
                    <div class="flex items-start gap-3">
                        ...
                        <p><strong>BERTANGGUNG JAWAB PENUH DAN MEMATUHI ATURAN</strong> yang ditetapkan pihak kampus terkait dengan penggunaan ruangan.</p>
                    </div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <p><strong>BERSEDIA MENJAGA KETERTIBAN, KEBERSIHAN, DAN INVENTARIS</strong> ruangan selama melaksanakan kegiatan di dalam ruangan.</p>
                    </div>
