<?php $__env->startSection('title', 'Edit Laboratorium - Admin'); ?>
...
<div class="max-w-3xl mx-auto">
    ...
    <!-- Header -->
    <div class="mb-8">
        <a href="<?php echo e(route('admin.labs.index')); ?>" class="text-blue-600 hover:text-blue-800 mb-4 inline-flex items-center gap-2 text-sm font-medium">
    ...
    <!-- Edit Form -->
    <form action="<?php echo e(route('admin.labs.update', $lab)); ?>" method="POST" class="bg-white rounded-xl shadow-lg p-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-8 p-6 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-200">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1">
                    <h3 class="text-xl font-bold text-gray-800"><?php echo e($lab->name); ?></h3>
                    <p class="text-gray-600 text-sm">Kode: <strong><?php echo e($lab->code); ?></strong></p>
                    <div class="flex items-center gap-2 mt-2">
                        <span class="inline-block px-3 py-1 text-xs rounded-full font-semibold
                            <?php if($lab->status === 'active'): ?> bg-green-100 text-green-800
                            <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                            <?php echo e($lab->status === 'active' ? '✅ Aktif' : '⏸️ Nonaktif'); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="name" value="<?php echo e(old('name', $lab->name)); ?>" required
                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="code" value="<?php echo e(old('code', $lab->code)); ?>" required maxlength="10"
                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?> uppercase"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <textarea name="description" rows="4"
                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                      placeholder="Jelaskan fasilitas dan kegunaan laboratorium..."><?php echo e(old('description', $lab->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="location" value="<?php echo e(old('location', $lab->location)); ?>"
                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input type="number" name="capacity" value="<?php echo e(old('capacity', $lab->capacity)); ?>" required min="1"
                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['capacity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <select name="status" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                ...
                <option value="active" <?php echo e(old('status', $lab->status) === 'active' ? 'selected' : ''); ?>>✅ Aktif</option>
                <option value="inactive" <?php echo e(old('status', $lab->status) === 'inactive' ? 'selected' : ''); ?>>⏸️ Nonaktif</option>
            </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
            <a href="<?php echo e(route('admin.labs.index')); ?>" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 transition-colors">Batal</a>
            ...
            <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl w-full max-w-md border border-gray-200">
                ...
                <div class="px-6 py-5">
                    ...
                    <div class="p-3 bg-red-50 border border-red-200 rounded-lg">
                        <p class="text-sm text-gray-700"><strong><?php echo e($lab->name); ?></strong></p>
                        <p class="text-xs text-gray-500 mt-1">Kode: <?php echo e($lab->code); ?> • Kapasitas: <?php echo e($lab->capacity); ?> orang</p>
                    </div>
                    <?php
                    ...
                    <div class="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <p class="text-xs text-yellow-700">⚠️ Laboratorium ini memiliki <strong><?php echo e($bookingCount); ?> booking</strong>. Data booking akan tetap tersimpan.</p>
                    </div>
                    <?php endif; ?>
                </div>
                <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3">
                    ...
                    <form action="<?php echo e(route('admin.labs.destroy', $lab)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel_project\sipinlab\resources\views/admin/labs/edit.blade.php ENDPATH**/ ?>