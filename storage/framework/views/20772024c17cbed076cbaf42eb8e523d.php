...
<div class="max-w-3xl mx-auto">
    ...
    <!-- Edit Form -->
    <form action="<?php echo e(route('admin.users.update', $user)); ?>" method="POST" class="bg-white rounded-xl shadow-lg p-8">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <!-- NIM/NIP (Read-only) -->
        <div class="mb-6">
            <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e($user->role === 'mahasiswa' ? '🎓 NIM' : '👨‍🏫 NIP'); ?></label>
            <input type="text" value="<?php echo e($user->role === 'mahasiswa' ? ($user->nim ?? '-') : ($user->nip ?? '-')); ?>"
        ...
        <div class="mb-6">
            ...
            <input type="text" value="<?php echo e(ucfirst(str_replace('_', ' ', $user->role))); ?>"
                   class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 text-gray-600" readonly>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" placeholder="Contoh: 081234567890"
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <input type="text" name="lab_name" value="<?php echo e(old('lab_name', $user->lab_name)); ?>" placeholder="Contoh: Multimedia Cerdas (MMC)"
                   class="w-full px-4 py-3 border border-blue-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['lab_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6 p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
            <label class="flex items-center gap-3 cursor-pointer">
                <input type="checkbox" name="is_kalab" value="1" <?php echo e($user->is_kalab ? 'checked' : ''); ?>
        ...
        <div class="flex justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
            <a href="<?php echo e(route('admin.users.index')); ?>" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg font-medium hover:bg-gray-200 transition-colors">Batal</a>
                ...
                <div class="px-6 py-5">
                    <div class="flex items-start gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Password akan direset ke: <strong class="text-orange-600"><?php echo e($user->role === 'mahasiswa' ? ($user->nim ?? explode('@', $user->email)[0]) : ($user->nip ?? explode('@', $user->email)[0])); ?></strong></p>
                        </div>
                    </div>
                    <div class="p-3 bg-gray-50 rounded-lg">
                        <p class="text-sm text-gray-700"><strong><?php echo e($user->name); ?></strong> <span class="text-gray-400">(<?php echo e($user->email); ?>)</span></p>
                    </div>
                </div>
            ...
            <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl w-full max-w-md border border-gray-200">
                ...
                <div class="px-6 py-5">
                    ...
                    <div class="p-3 bg-red-50 border border-red-200 rounded-lg">
                        <p class="text-sm text-gray-700"><strong><?php echo e($user->name); ?></strong></p>
                        <p class="text-xs text-gray-500 mt-1"><?php echo e($user->email); ?> • <?php echo e(ucfirst(str_replace('_', ' ', $user->role))); ?> <?php if($user->lab_name): ?> • <?php echo e($user->lab_name); ?> <?php endif; ?></p>
                    </div>
                    <?php if($user->is_kalab): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel_project\sipinlab\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>