...
<?php $__env->startSection('title', 'Dashboard Staff - Polije'); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <?php if($isKalab || $isTeknisi): ?>
    <div class="mb-6">
        <!-- Header Stats -->
        <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-bold text-gray-800">
                <?php echo e($isKalab ? '📊 Statistik Semua Laboratorium' : '📊 Statistik Laboratorium: ' . $userLab); ?>

            </h3>
            <?php if($isTeknisi): ?>
                <span class="text-xs text-gray-500 bg-gray-100 px-3 py-1 rounded-full">
                    🔒 Hanya data lab <?php echo e($userLab); ?>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
            ...
            <div class="bg-white rounded-xl shadow-sm p-3 border border-gray-200 hover:shadow-md transition-shadow relative overflow-hidden">
                ...
                <p class="text-lg font-bold text-green-600"><?php echo e($stats['bookings_today'] ?? 0); ?></p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-3 border border-gray-200 hover:shadow-md transition-shadow relative overflow-hidden">
                ...
                <p class="text-lg font-bold text-blue-600"><?php echo e($stats['bookings_this_week'] ?? 0); ?></p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-3 border border-gray-200 hover:shadow-md transition-shadow relative overflow-hidden">
                ...
                <p class="text-lg font-bold text-purple-600"><?php echo e($stats['bookings_current_month'] ?? 0); ?></p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-3 border border-gray-200 hover:shadow-md transition-shadow relative overflow-hidden">
                ...
                <p class="text-lg font-bold text-orange-600"><?php echo e($stats['bookings_last_month'] ?? 0); ?></p>
            </div>

            <!-- ⏳ Pending -->
            <div class="bg-white rounded-xl shadow-sm p-3 border border-gray-200 hover:shadow-md transition-shadow">
                <p class="text-xs text-gray-500">⏳ Pending</p>
                <p class="text-lg font-bold text-yellow-600"><?php echo e($stats['pending_count'] ?? 0); ?></p>
            </div>

            <!-- ✅ Confirmed -->
            <div class="bg-white rounded-xl shadow-sm p-3 border border-gray-200 hover:shadow-md transition-shadow">
                <p class="text-xs text-gray-500">✅ Confirmed</p>
                <p class="text-lg font-bold text-green-600"><?php echo e($stats['confirmed_count'] ?? 0); ?></p>
            </div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <?php if(!$isKalab && !$isTeknisi && !empty($stats['my_bookings'])): ?>
    <div class="mb-6 grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Total Booking Saya</p>
            <p class="text-xl font-bold text-blue-600"><?php echo e($stats['my_bookings']); ?></p>
        </div>
        <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Menunggu</p>
            <p class="text-xl font-bold text-yellow-600"><?php echo e($stats['my_pending']); ?></p>
        </div>
        <div class="bg-white rounded-xl shadow-sm p-4 border border-gray-200">
            <p class="text-xs text-gray-500">Disetujui</p>
            <p class="text-xl font-bold text-green-600"><?php echo e($stats['my_confirmed']); ?></p>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="mb-6 bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <form method="GET" action="<?php echo e(route('dashboard.staff')); ?>" class="flex flex-wrap items-center gap-4" id="filterForm">
            ...
            <span class="text-xs text-gray-500 ml-2">
                ...
                pada <strong class="text-blue-600"><?php echo e($scheduleDayName ?? ''); ?>, <?php echo e(Carbon::parse($scheduleDate ?? date('Y-m-d'))->isoFormat('D MMM Y')); ?></strong>
                <?php if(Auth::user()->isKalab()): ?>
                    | Mode: <strong class="<?php echo e(session('dashboard_view_mode', 'schedule') === 'management' ? 'text-indigo-600' : 'text-blue-600'); ?>">
                        <?php echo e(session('dashboard_view_mode', 'schedule') === 'management' ? '👔 Kalab' : '🎓 Dosen'); ?>
            ...
            <a href="<?php echo e(route('dashboard.staff')); ?>" class="text-sm text-gray-500 hover:text-gray-700 underline">
                🔄 Reset
            </a>
            <?php endif; ?>
        </form>
    ...
    <!-- ======================================================================== -->
    <?php if($isKalabView && !empty($stats)): ?>
    <div class="mb-6 grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="bg-orange-50 border border-orange-200 rounded-xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-orange-800"><?php echo e($stats['pending_count'] ?? 0); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-blue-800"><?php echo e($stats['approved_dosen_count'] ?? 0); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-indigo-50 border border-indigo-200 rounded-xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-indigo-800"><?php echo e($stats['approved_teknisi_count'] ?? 0); ?></p>
                </div>
            </div>
        </div>
        <div class="bg-green-50 border border-green-200 rounded-xl p-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-green-800"><?php echo e($stats['confirmed_count'] ?? 0); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="scheduleContainer">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors <?php echo e(($item['is_break'] ?? false) ? 'bg-gray-100' : ''); ?>">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm">
                                    <?php if(!($item['is_break'] ?? false)): ?>
                                        ...
                                        <?php elseif(in_array(($item['status'] ?? ''), ['pending', 'approved_dosen', 'approved_teknisi']) && $isKalabView): ?>
                                            
                                            <div class="flex flex-col gap-1">
                                                <span class="text-xs text-gray-500"><?php echo e($item['booking_info'] ?? ''); ?></span>
                                                <?php if($item['status'] === 'approved_teknisi'): ?>
                                                    <form action="<?php echo e(route('booking.approve-kalab', $item['booking_id'])); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
        ...
        <div class="text-center py-12 bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <a href="<?php echo e(route('dashboard.staff')); ?>" class="text-blue-600 hover:underline mt-2 inline-block">Reset filter</a>
        </div>
        <?php endif; ?>
    </div>
...
if (ctxLab && <?php echo json_encode($chartLabLabels ?? [], 15, 512) ?>.length > 0) {
    new Chart(ctxLab, {
        type: 'bar',
        data: {
...
if (ctxDay && <?php echo json_encode($chartDayLabels ?? [], 15, 512) ?>.length > 0) {
    new Chart(ctxDay, {
        type: 'pie',
        data: {
...
if (ctxActivity && <?php echo json_encode($chartActivityLabels ?? [], 15, 512) ?>.length > 0) {
...
if (ctxBorrowers && <?php echo json_encode($chartBorrowerLabels ?? [], 15, 512) ?>.length > 0) {
...
function toggleViewMode(mode) {
    ...
    // AJAX request
    fetch("<?php echo e(route('dashboard.toggle-view-mode')); ?>", {
        method: 'POST',
        headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\laravel_project\sipinlab\resources\views/dashboard/staff.blade.php ENDPATH**/ ?>